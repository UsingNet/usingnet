...
import { Col, Form, Input, InputNumber, Select, Button, message } from 'antd';
...
class EmailForm extends React.Component {
    componentDidMount() {
        Store.setting.email.subscribe(this.emailDataLoaded);
    }

    componentWillUnmount() {
        Store.setting.email.unsubscribe(this.emailDataLoaded);
    }
    ...
    handleSubmit = (e) => {
        ...
        this.props.form.validateFields((errors, values) => {
            ...
            Store.setting.email.save(data).then(resp => {
                if (resp.success) {
    ...
    render() {
        ...
        const serverValidate = {
            validate: [{
                rules: [
                    { required: true, message: '服务器主机名不能为空' },
                ],
            }],
        };
        ...
        const portValidate = {
            ...
            validate: [{
                rules: [
                    { required: true, message: '服务器端口不能为空' },
                ],
            }],
        };
...
const Email = Form.create()(EmailForm);
