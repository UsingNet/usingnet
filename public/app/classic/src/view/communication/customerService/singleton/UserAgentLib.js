 ...
 */
Ext.define('Admin.view.communication.customerService.singleton.UserAgentLib', {
    singleton: true,
    windowVersion: {
        '5.0': '2000',
        '5.1': 'XP',
    ...
    parse: function(user_agent) {
        if (!user_agent) {
            user_agent = '';
        }

        var detail = this.analyze(user_agent);

        return {
            os: (detail.device.full?(detail.device.full+' '):'') + detail.os.full,
            browser: {
                name: detail.browser.full,
                family: detail.browser.name,
                version: detail.browser.version
            },
            detail: detail
        };
    },
    ...
    constructor:function(){
        ...
        (function (root) {
            ...
            root.browserAnalyze = function (uaString) {
                var ret = {
                    ua: uaString,
                    name: "",
                    version: "",
        ...
        (function (root) {
            ...
            root.deviceAnalyze = function (uaString) {
                var ret = {
                    "ua": uaString,
                    "name": "",
                    "image": "",
        ...
        (function (root) {
            ...
            root.osAnalyze = function (uaString) {
                var ret = {
                    ua: uaString,
                    name: "",
                    version: "",
        ...
        (function (root) {
            root.analyze = function (uaString) {
                var returnObject = {};
                returnObject.ua = uaString;
                returnObject.os = root.osAnalyze(uaString);
                returnObject.device = root.deviceAnalyze(uaString);
                returnObject.browser = root.browserAnalyze(uaString);
