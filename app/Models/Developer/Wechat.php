...
class Wechat
{
    ...
    {
        $api = sprintf('https://qyapi.weixin.qq.com/cgi-bin/user/get?access_token=%s&userid=%s', self::getAccessToken(), $userId);
...
EOL;
    ...
    */
    ...
    public static function getAccessToken()
    {
        ...
        if (!$accessToken) {
            $api = sprintf($api, Config::get('developer.appid'), Config::get('developer.secret'));
